		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comcuprumzccbgs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcuprumzccbgs-display": {
								"semanticObject": "comcuprumzccbgs",
								"action": "display",
								"description": "App CCB",
								"title": "App Title",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cuprum.zccbgs",
									"url": sap.ui.require.toUrl("com/cuprum/zccbgs")
								}
							}
						}
					}
